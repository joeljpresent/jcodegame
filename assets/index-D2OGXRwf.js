...
function ScriptField({ value, onChange }) {
...
function isUnicodeCodePoint(n) {
  return n >= 0 && n <= 1114111 && !(n >= 55296 && n <= 57343);
}
function toUnicode(arr) {
  return String.fromCodePoint(...arr.map((n) => isUnicodeCodePoint(n) ? n : 65533));
}
function toUnicodeChar(n) {
  return String.fromCodePoint(isUnicodeCodePoint(n) ? n : 65533);
}
const ESCAPE = {
  "\\": "\\".charCodeAt(0),
  "'": "'".charCodeAt(0),
...
function ExeOutput({ output, error, isTextMode }) {
  function outputDisplay() {
    if (output.length === 0) {
      return /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("i", { children: "Empty output." }) });
    } else if (isTextMode) {
      return /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { children: toUnicode(output) });
    }
    return /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: output.join(", ") });
  }
...
function isExeError(v) {
  return v != null && typeof v === "object" && Object.hasOwn(v, "lineNumber") && Object.hasOwn(v, "msg");
}
function isWhiteSpace(char) {
  return [" ", "	", "\r"].includes(char);
}
function lexScript(script) {
  try {
    return script.split("\n").map((line, lineIdx) => {
      function err(msg) {
        return {
...
function initExeState(script, settings) {
...
function shouldExeContinue(state) {
  return state.lineIdx < state.commands.length && state.nextInputIdx <= state.input.length && state.error == null;
}
function setLineIdx(state, newLineIdx) {
...
function runCommand(args, state) {
  const checkCellIdx = (cellIdx) => {
...
function runScript(script, settings) {
...
function ScriptVisualizer({ exeState }) {
  ...
  function commandLine(args, idx) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: getLineStyle(idx), children: [
      "[",
      idx + 1,
      "] ",
      args.join(" ")
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: exeState.commands.map((args, idx) => commandLine(args, idx)) });
}
function ValueVisualizer({ exeState }) {
  function row(name, val) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { style: { paddingRight: "1em" }, children: name }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { style: { paddingRight: "1em" }, children: val }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: toUnicodeChar(val) })
    ] }, name);
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("table", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
    row("cur", exeState.currentValue),
    exeState.cells.map((val, idx) => row(`@${idx}`, val))
  ] }) });
}
function createInputSuccess(text, value) {
  return {
    text,
    status: "success",
    value
...
function createInputError(text, errorMessage) {
  return {
    text,
    status: "error",
    error: errorMessage
...
function parseInputField(text, isTextMode) {
  try {
    if (isTextMode) {
...
function isWhiteSpaceOrComma(char) {
  return [" ", "	", "\r", "\n", ","].includes(char);
}
function parseNumericInputField(text) {
  const numbers = [];
  let idx = 0;
...
function ExeInputVisualizer({ input, nextInputIdx, isTextMode }) {
  function getValueStyle(idx) {
  ...
  if (isTextMode) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("pre", { children: [
      input.map((v, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: getValueStyle(idx), children: toUnicodeChar(v) }, idx)),
      endDisplay()
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
    input.map((v, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: getValueStyle(idx), children: [
      v,
      ", "
    ] }, idx)),
    endDisplay()
...
function ExeInputField({ input, onChange, isTextMode }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: input.status === "success" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      ExeInputVisualizer,
      {
        input: input.value,
        nextInputIdx: null,
    ...
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "red" }, children: input.error }) })
  ] });
}
function TextModeToggle({ isTextMode, onToggleTextMode }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "toggleTextModeButton", children: isTextMode ? "Text mode" : "Numeric mode" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        children: isTextMode ? "To numeric" : "To text"
      }
    )
  ] }) });
}
function HelpDialog() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: showDialog, children: "🛈 Help" }),
...
function CodeGame() {
  ...
  const [exeInput, setExeInput] = reactExports.useState(createInputSuccess("", []));
  const [isStepByStep, setIsStepByStep] = reactExports.useState(false);
  const [isExeInputTextMode, setIsExeInputTextMode] = reactExports.useState(false);
  const [isExeOutputTextMode, setIsExeOutputTextMode] = reactExports.useState(false);
  const [exeState, setExeState] = reactExports.useState(null);
  function createSettings() {
    if (exeInput.status === "error") {
      return null;
    }
    return {
      maxInstructionCount: 1e4,
      cellCount: 16,
  ...
  function handleExeInputChange(nextInput) {
    setExeInput(nextInput);
  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "flex flex-row w-full justify-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pr-[1rem]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "JCodeGame" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "pl-[5px]", htmlFor: "stepByStepCheckbox", children: "Step-by-step mode" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Input" }),
      isStepByStep && exeState != null && exeInput.status === "success" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        ExeInputVisualizer,
        {
          input: exeInput.value,
          nextInputIdx: (exeState == null ? void 0 : exeState.nextInputIdx) ?? 0,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Script" }),
      isStepByStep && exeState != null ? /* @__PURE__ */ jsxRuntimeExports.jsx(ScriptVisualizer, { exeState }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ScriptField, { value: script, onChange: handleScriptChange }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pl-[1rem]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Output" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        TextModeToggle,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ExeOutput,
        {
          output: (exeState == null ? void 0 : exeState.output) ?? [],
          error: (exeState == null ? void 0 : exeState.error) ?? null,
          isTextMode: isExeOutputTextMode
        }
      ),
      isStepByStep && exeState != null && /* @__PURE__ */ jsxRuntimeExports.jsx(ValueVisualizer, { exeState })
    ] })
  ] });
}
clientExports.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "min-h-screen flex-col pt-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CodeGame, {}) }) })
);
